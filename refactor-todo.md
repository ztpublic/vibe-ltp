...
- Theming surface: expand `ICustomStyles` into slot-based styles or CSS variables for container/header/input, bot/user bubbles (bg/text/border/radius/shadow), arrows, reply label, loader, and avatars; allow className overrides per slot.
